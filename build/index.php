...
/**
 * 整合压缩工具
 * 将所有相关js源码和css文件进行整合和压缩，输出GAMEFRAMEWORK-version.min.js
...
define('GAMEFRAMEWORK', dirname(dirname(__FILE__)) );
...
//读取js文件
$script = read_file( file(GAMEFRAMEWORK."/build/source_{$source}.txt") );
...
//定义临时文件，运行结束后会删除
$tmp_script_file = GAMEFRAMEWORK."/build/game_tmp.js";
